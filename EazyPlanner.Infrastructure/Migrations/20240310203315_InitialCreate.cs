    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BankrollAccountId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Create_CreateAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Create_CreatedBy = table.Column<string>(type: "text", nullable: false),
                    Create_UpdateAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Create_UpdateBy = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyFantasy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ProvinceId = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    ...
                    Address_SecondaryAddress = table.Column<string>(type: "text", nullable: false),
                    Address_State = table.Column<string>(type: "text", nullable: false),
                    Address_StreetName = table.Column<string>(type: "text", nullable: false),
                    Address_ZipCode = table.Column<string>(type: "text", nullable: false),
                    Contact_Email1 = table.Column<string>(type: "text", nullable: false),
                    Contact_Email2 = table.Column<string>(type: "text", nullable: false),
                    Contact_Image = table.Column<string>(type: "text", nullable: false),
                    Contact_Phone1 = table.Column<string>(type: "text", nullable: false),
                    Contact_Phone2 = table.Column<string>(type: "text", nullable: false),
                    Contact_Website = table.Column<string>(type: "text", nullable: false),
                    Create_CreateAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Create_CreatedBy = table.Column<string>(type: "text", nullable: false),
                    Create_UpdateAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Create_UpdateBy = table.Column<string>(type: "text", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerSupplierId = table.Column<int>(type: "integer", nullable: true),
                    Create_CreateAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Create_CreatedBy = table.Column<string>(type: "text", nullable: false),
                    Create_UpdateAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Create_UpdateBy = table.Column<string>(type: "text", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActualAmount = table.Column<decimal>(type: "money", precision: 10, scale: 2, nullable: true),
                    RecordType = table.Column<string>(type: "text", nullable: false),
                    Status = table.Column<string>(type: "text", nullable: true),
                    BankrollAccountId = table.Column<int>(type: "integer", nullable: true),
                    CosteCenterId = table.Column<int>(type: "integer", nullable: true),
                    CustomerSupplierId = table.Column<int>(type: "integer", nullable: true),
